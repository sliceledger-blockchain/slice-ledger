...
[`OptimismPortal`](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/packages/contracts-bedrock/contracts/L1/OptimismPortal.sol) has an immutable `GUARDIAN`.
That address can call [`pause`](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/packages/contracts-bedrock/contracts/L1/OptimismPortal.sol#L166-L170) and [`unpause`](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/packages/contracts-bedrock/contracts/L1/OptimismPortal.sol#L175-L179).
...
You do this using the L1 [`ProxyAdmin`](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/packages/contracts-bedrock/contracts/universal/ProxyAdmin.sol) contract.
