...
- [Specifications](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/specs/derivation.md#batch-submission-wire-format)
- [Source code](https://github.com/sliceledger-blockchain/slice-ledger/tree/develop/op-batcher)
...
- [Specifications](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/specs/derivation.md#l2-chain-derivation-pipeline)
- [Source code](https://github.com/sliceledger-blockchain/slice-ledger/tree/develop/op-node)
...
- [Specifications](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/specs/exec-engine.md) (where it differs from [geth](https://geth.ethereum.org/))
...
- [Specifications](https://github.com/sliceledger-blockchain/slice-ledger/blob/develop/specs/withdrawals.md) (called [withdrawal transactions](https://community.optimism.io/docs/developers/bridge/messaging/#))
- [Source code](https://github.com/sliceledger-blockchain/slice-ledger/tree/develop/packages/contracts-bedrock/contracts)
