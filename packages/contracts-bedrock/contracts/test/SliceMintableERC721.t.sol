...
import {
    SliceMintableERC721,
    ISliceMintableERC721
} from "../universal/SliceMintableERC721.sol";

contract SliceMintableERC721_Test is ERC721Bridge_Initializer {
    ERC721 internal L1Token;
    SliceMintableERC721 internal L2Token;
    ...
    function setUp() public override {
        ...
        L2Token = new SliceMintableERC721(
            address(L2Bridge),
            1,
            address(L1Token),
            "L2Token",
    ...
    function test_supportsInterfaces_succeeds() external {
        // Checks if the contract supports the ISliceMintableERC721 interface.
        assertTrue(L2Token.supportsInterface(type(ISliceMintableERC721).interfaceId));
    ...
    function test_safeMint_notBridge_reverts() external {
        ...
        vm.expectRevert("SliceMintableERC721: only bridge can call this function");
