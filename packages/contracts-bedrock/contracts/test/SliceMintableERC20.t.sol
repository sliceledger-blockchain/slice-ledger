...
import {
    ...
    ISliceMintableERC20
} from "../universal/ISliceMintableERC20.sol";
import { IERC165 } from "@openzeppelin/contracts/utils/introspection/IERC165.sol";

contract SliceMintableERC20_Test is Bridge_Initializer {
    ...
    function test_mint_notBridge_reverts() external {
        // NOT the bridge
        vm.expectRevert("SliceMintableERC20: only bridge can mint and burn");
    ...
    function test_erc165_supportsInterface_succeeds() external {
        ...
        assertEq(iface3, type(ISliceMintableERC20).interfaceId);
