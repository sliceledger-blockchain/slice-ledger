...
contract SlicePortal_Depositor is StdUtils, ResourceMetering {
    Vm internal vm;
    SlicePortal internal portal;
    bool public failedToComplete;

    constructor(Vm _vm, SlicePortal _portal) {
        vm = _vm;
        portal = _portal;
        initialize();
    }
...
contract SlicePortal_Invariant_Harness is Portal_Initializer {
...
contract SlicePortal_Deposit_Invariant is Portal_Initializer {
    SlicePortal_Depositor internal actor;

    function setUp() public override {
        super.setUp();
        // Create a deposit actor.
        actor = new SlicePortal_Depositor(vm, op);
...
contract SlicePortal_CannotTimeTravel is SlicePortal_Invariant_Harness {
    function setUp() public override {
        super.setUp();
...
contract SlicePortal_CannotFinalizeTwice is SlicePortal_Invariant_Harness {
    function setUp() public override {
        super.setUp();
...
contract SlicePortal_CanAlwaysFinalizeAfterWindow is SlicePortal_Invariant_Harness {
    function setUp() public override {
        super.setUp();
