...
contract PostSherlockL1 is SafeBuilder {
    ...
    string constant internal SlicePortal_Version = "1.6.0";
    ...
    function setUp() external {
        implementations[GOERLI] = ContractSet({
            ...
            SliceMintableERC20Factory: 0x0EebA1A5da867EB3bc0956f6389d490d0F4b8086,
            SlicePortal: 0x9e760aBd847E48A56b4a348Cba56Ae7267FeCE80,
        ...
        proxies[GOERLI] = ContractSet({
            ...
            SliceMintableERC20Factory: 0x883dcF8B05364083D849D8bD226bC8Cb4c42F9C5,
            SlicePortal: 0x5b47E1A08Ea6d985D6649300584e6722Ec4B1383,
    ...
    function _postCheck() internal override view {
        ...
        require(_versionHash(prox.SlicePortal) == keccak256(bytes(SlicePortal_Version)), "SlicePortal");
        ...
        require(PROXY_ADMIN.getProxyImplementation(prox.SliceMintableERC20Factory).codehash == impl.SliceMintableERC20Factory.codehash, "SliceMintableERC20Factory codehash");
        require(PROXY_ADMIN.getProxyImplementation(prox.SlicePortal).codehash == impl.SlicePortal.codehash, "SlicePortal codehash");
    ...
    function buildCalldata(address _proxyAdmin) internal override view returns (bytes memory) {
        ...
        // Upgrade the SlicePortal
        calls[4] = IMulticall3.Call3({
            target: _proxyAdmin,
            allowFailure: false,
            callData: abi.encodeCall(
                ProxyAdmin.upgrade,
                (payable(prox.SlicePortal), impl.SlicePortal)
            )
        });
